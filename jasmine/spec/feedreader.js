    ...
    describe('New Feed Selection', function () {
        ...
        beforeEach(function (done) {
            loadFeed(0, function () {
                ...
                console.log('iniitial' + initialHTML);
                loadFeed(1, done);
            });
        });
         ...
         */
        it('content should change after a new feed is loaded', function (done) {
            updatedHTML = $('.feed').html();
            console.log('updated' + updatedHTML);
            expect(initialHTML).not.toEqual(updatedHTML);
            done();
        });
    });
}());